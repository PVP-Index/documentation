...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { slug: 'proxy-setup-bungeecord', label: 'Proxy setup (BungeeCord)', file: 'server_owner/proxy-setup-bungeecord.md', description: 'Cross-server challenges and player transfers via BungeeCord.' },
      { slug: 'multi-proxy-setup', label: 'Multi-proxy setup', file: 'server_owner/multi-proxy-setup.md', description: 'Redis-backed networking across multiple Velocity/BungeeCord proxies.' },
      { slug: 'language-customization', label: 'Language customisation', file: 'server_owner/language-customization.md', description: 'Switch languages, customise messages, or add your own translation.' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'anti-cheat-rules', label: 'Anti-cheat rules', file: 'server_mod/anti-cheat-rules.md', description: 'The three auto-cheat rules, their thresholds, and how to act on flags.' },
