...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { slug: 'arenas-and-templates', label: 'Arenas & templates', file: 'server_owner/arenas-and-templates.md', description: 'Set up arenas and the warm pool.' },
  ...
  },
  {
    ...
    description: 'Build against the public API: read endpoints, submit battles, sign payloads.',
    iconPath: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4',
    items: [
      { slug: 'public-api', label: 'Public API', file: 'server_developer/public-api.md', description: 'Base URL, response shape, and read endpoints.' },
